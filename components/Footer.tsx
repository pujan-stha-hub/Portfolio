        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="p-2.5 rounded-lg text-slate-500 hover:text-black hover:bg-slate-100 transition-all duration-200"
              aria-label="LinkedIn"
            >
              <LinkedInIcon />
            </a>
            ...
            <a
              href="mailto:pujanshrestha77@gmail.com"
              className="p-2.5 rounded-lg text-slate-500 hover:text-black hover:bg-slate-100 transition-all duration-200"
              aria-label="Email"
            >
              <Mail size={20} />
          ...
          <button
            onClick={scrollToTop}
            className="flex items-center gap-2 text-slate-600 hover:text-black text-sm transition-colors group font-medium"
          >
